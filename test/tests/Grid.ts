namespace mirage.tests {
    ...
    QUnit.test("setters", (assert) => {
        ...
        map.getSetter("row-definitions")(grid, NewRowDefinitions("*"));
        ...
        map.getSetter("column-definitions")(grid, NewColumnDefinitions("*"));
